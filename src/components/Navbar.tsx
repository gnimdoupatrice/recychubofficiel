    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
          scrolled
            ? "h-16 bg-black/65 backdrop-blur-2xl border-b border-white/10 shadow-2xl shadow-black/40"
            : "h-20 bg-gradient-to-b from-black/45 via-black/25 to-transparent backdrop-blur-md"
        } flex items-center`}
      >
        ...
        <div className="container max-w-[1440px] mx-auto px-5 lg:px-10 flex items-center justify-between gap-8 w-full">
          ...
          <Link to="/" className="flex items-center gap-3 shrink-0 select-none" aria-label="RecycHub Togo — Accueil">
            ...
            />
            <span className="hidden sm:inline-block font-editorial font-bold text-[16px] tracking-tight text-white leading-none">
