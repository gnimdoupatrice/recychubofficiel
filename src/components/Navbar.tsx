      ...
      >
        ...
        <div className="container max-w-[1440px] mx-auto px-5 lg:px-10 flex items-center justify-between gap-8 w-full">
          ...
          <div className="hidden lg:flex flex-1 items-center justify-center gap-0.5 xl:gap-1.5 max-w-3xl">
            ...
            {/* Alerte dépotoir — jaune→rouge + live counter */}
            <Link
              to="/alerte"
          ...
          <div className="max-w-md mx-auto space-y-6">
            <div>
              ...
              <div className="space-y-2">
                <Link to="/vendre" className="flex items-center gap-3 p-3 rounded-2xl bg-muted border border-border hover:border-primary/30 transition-colors">
                ...
                <Link to="/enlevement" className="flex items-center gap-3 p-3 rounded-2xl bg-muted border border-border hover:border-primary/30 transition-colors">
                ...
                <Link to="/alerte" className="flex items-center gap-3 p-3 rounded-2xl bg-muted border border-border hover:border-destructive/30 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-1">
                <Link to="/" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-muted text-foreground font-medium">
                  Accueil
                </Link>
                {discoverLinks.map(link => (
                  <Link key={link.to} to={link.to} className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-muted text-foreground font-medium">
            ...
            <div className="pt-4 border-t border-border space-y-2">
              {user ? (
                <>
                  ...
                  <button onClick={handleSignOut} className="w-full text-left px-3 py-3 rounded-xl hover:bg-muted text-foreground font-medium flex items-center gap-2">
                    <LogOut className="w-5 h-5" /> Déconnexion
                  </button>
                </>
              ) : (
                <Link to="/inscription" className="flex items-center justify-center gap-2 px-5 py-3.5 rounded-full bg-secondary text-secondary-foreground font-bold">
