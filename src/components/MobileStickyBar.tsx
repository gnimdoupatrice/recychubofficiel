...
const MobileStickyBar = () => (
  <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
    <div className="bg-background/95 backdrop-blur-xl border-t border-border px-3 py-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] flex items-center gap-2">
      <Link
        to="/enlevement"
        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-full bg-secondary text-secondary-foreground font-bold text-sm active:scale-95 transition-transform"
      >
      ...
      <Link
        to="/vendre"
        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-full border-2 border-primary text-primary font-bold text-sm active:scale-95 transition-all"
      >
